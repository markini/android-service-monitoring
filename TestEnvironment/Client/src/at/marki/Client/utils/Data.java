...
public class Data {
	...
	public static void createMockMessages(Context context) {
		...
		messages.add(new Message(UUID.randomUUID().toString(), "A friend is someone who knows all about you and still loves you.", Long.parseLong("1376928000000")));
		messages.add(new Message(UUID.randomUUID().toString(), "Always forgive your enemies; nothing annoys them so much.", Long.parseLong("1376928000000")));
		messages.add(new Message(UUID.randomUUID().toString(), "Without music, life would be a mistake.", Long.parseLong("1376928000000")));
		...
		messages.add(new Message(UUID.randomUUID().toString(), "Our neural pathways have become accustomed to your sensory input patterns.", Long.parseLong("1377878400000")));
		messages.add(new Message(UUID.randomUUID().toString(), "Please, Captain, not in front of the Klingons.", Long.parseLong("1377878400000")));
		messages.add(new Message(UUID.randomUUID().toString(), "It can be argued that a human is ultimately the sum of his experiences.", Long.parseLong("1377878400000")));
